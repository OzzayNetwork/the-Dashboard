...
options = {
    ...
    chart: { type: "area", height: 350, toolbar: "false" },
    yaxis: {
        labels: {
            formatter: function(value) {
                // return "KES " + value;
    ...
    colors: ["#f1b44c"],
    fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: .6, opacityTo: .05, stops: [42, 100, 100, 100] } }
};
